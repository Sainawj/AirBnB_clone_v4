...
class TestBasemodel(unittest.TestCase):
    ...
    def test_todict(self):
        ...
        # Check if to_dict has correct keys
        ...
        # Check if to_dict includes added attributes
        mdl = self.value()
        ...
        # Check if to_dict datetime attributes are strings
        ...
        # Check to_dict output contradiction
        mdl_d = self.value()
    ...
    def test_kwargs_one(self):
        """Tests single kwargs key-value pair."""
        n = {'Name': 'test'}
        new = self.value(**n)
    ...
    def test_created_at(self):
        """Tests created_at attribute type."""
        new = self.value()
        self.assertEqual(type(new.created_at), datetime)

    def test_updated_at(self):
        """Tests updated_at attribute type."""
        new = self.value()
