#!/usr/bin/python3
"""Defines a console module for managing objects in a storage system."""
...
class HBNBCommand(cmd.Cmd):
    """Provides commands to interact with objects in the storage system."""
    ...
    def preloop(self):
        """Prints prompt if stdin is not interactive."""
